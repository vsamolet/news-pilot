...
3. АТРИБУЦИЯ: обязательно упомяни первоисточник органично внутри текста — в одном из абзацев фактуры (2-м или 3-м), — используя конструкции вроде "как пишет {quoted_name}", "сообщает {quoted_name}". Никогда не в заголовке и не в первом предложении лида.
4. СТИЛЬ: строгий деловой русский язык. Категорически запрещены вступительные и заключительные фразы от первого лица или обращения к читателю — "в этой статье мы рассмотрим", "подводя итог, отметим", "как мы видим", "стоит отметить, что" и подобные. Никаких оценочных штампов.
5. ЭТО РЕРАЙТ, А НЕ КОПИРОВАНИЕ. Перескажи своими словами: порядок изложения, структура предложений и формулировки должны заметно отличаться от исходного текста, дословное сходство с оригиналом недопустимо. Дословно можно сохранять только цифры, даты, прямые цитаты в кавычках и имена/должности — всё остальное перефразируй.
